...
export default class RideScreen extends Component {
    ...
    handleTransaction = async () => {
        ...
        if (!transactionType) {
            ...
            // Faça uma mensagem de alerta para aparecer n a tela para inserir um ID de bicicleta válido
            Alert.alert("A bike que você está procurando não existe no banco de dados");
